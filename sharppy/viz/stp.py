...
class backgroundSTP(QtGui.QFrame):
    ...
    def draw_frame(self, qp):
        ...
        rect1 = QtCore.QRectF(1.5,3, self.brx, self.plot_height)
        qp.drawText(rect1, QtCore.Qt.TextDontClip | QtCore.Qt.AlignCenter,
            'STP efectivo (con CIN)')
...
class plotSTP(backgroundSTP):
    ...
    def draw_box(self, qp):
        ...
        texts = ['Prob. EF2+ supercelular', 'CLIMO = .15 sigtor']
        for text in texts:
        ...
        texts = ['basado en CAPE: ', 'basado en NCA:', 'basado en ESRH:', 'basado en EBWD:',
                 'basado en STP (cin):', 'basado en STP (fix):' ]
